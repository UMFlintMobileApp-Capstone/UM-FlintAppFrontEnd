...
class AcademicCalendar : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setSupportActionBar(binding.appBarAcademicCalendar.toolbar)

        binding.appBarAcademicCalendar.fab.setOnClickListener { view ->
        ...
        val navController = findNavController(R.id.nav_host_fragment_content_academic_calendar)
...
//                }
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        menuInflater.inflate(R.menu.academic_calendar, menu)
        return true
    }
